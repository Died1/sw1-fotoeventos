                    ...
                    <div class="row">
                        <div class="col-sm-10 position-relative mx-auto">
                            <div class="auth-content py-8">
                                ...
                                <form class="w-100" action="{{ URL::to('login') }}" method="post">
                                    @csrf
                                    <div class="row">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row gx-3">
                                                        <div class="form-group col-lg-12">
                                                            ...
                                                            <input class="form-control" placeholder="Enter email" name="email" value="" type="email">
                                                        </div>
                                                        <div class="form-group col-lg-12">
                                                            <div class="form-label-group">
                                                            ...
                                                            <div class="input-group password-check">
                                                                <span class="input-affix-wrapper">
                                                                    <input class="form-control" name="password" placeholder="Enter your password" value="" type="password">
